...
public class InventoryLoliPickaxe implements IInventory {
	...
	public void setField(int id, int value) {
		if (id == 0) {
			if (value < 0) {
				value = 0;
			} else if (value >= ConfigLoader.loliPickaxeMaxPage) {
				value = ConfigLoader.loliPickaxeMaxPage - 1;
			}
			if (value >= pages.size()) {
	...
	public NonNullList<ItemStack> getPage(int index) {
		if (index >= 0 && index < ConfigLoader.loliPickaxeMaxPage) {
