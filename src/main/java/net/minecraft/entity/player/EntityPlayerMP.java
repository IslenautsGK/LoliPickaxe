...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener {
	...
	/**
	 * This is a queue that contains the entity IDs of entties that need to be
	 * removed on the client. Adding an entity ID to this queue will cause a
	 * SPacketDestroyEntities to be sent to the client.
	 */
	...
	public void sendAllContents2(Container containerToSend, NonNullList<ItemStack> itemsList) {
		this.connection.sendPacket(new SPacketWindowItems(containerToSend.windowId, itemsList));
		this.connection.sendPacket(new SPacketSetSlot(-1, -1, this.inventory.getItemStack()));
	}
